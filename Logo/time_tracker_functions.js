...
// ============================================================================
// LOGO CONFIGURATION FUNCTIONS - Add these to time_tracker_functions.js v1.1.10.2
// ============================================================================

// Update the showConfigureApp() function to handle logo configuration
...
// New function to clear logo URL
...
// Update saveConfiguration function to handle logo URL
...
// Enhanced validateLogoUrl function for better validation
function validateLogoUrl(url) {
    if (!url || !url.trim()) return true; // Empty URL is valid (use default)
...
if (typeof window !== 'undefined') {
    ...
    console.log('Logo configuration functions loaded successfully');
}
